            ...
            <table class="table table-head-fixed text-nowrap table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="" data-toggle="modal" data-target="#modal-lg" onclick='setDadosModal(<?php echo htmlspecialchars( $value1["idmarca"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)'
              ...
              <div class="form-group">
                <div class="form-line row">
                  ...
                  <div class="col-sm">
                    ...
                    <input type="text" class="form-control" maxlength="100" id="nomemarca" name="nomemarca"
                      placeholder="Digite o nome da marca">
                  </div>
                  <div class="col-sm">
                    <label for="descricaomarca" id="labelDescrição">Descrição</label>
                    <input type="text" class="form-control" maxlength="500" id="descricaomarca" name="descricaomarca"
...
<script type="text/javascript" language="javascript">
  ...
  function menuAtivo() {
    document.getElementById('titulopainel').innerHTML = "<strong>Marca</strong>";
    document.getElementById('menumarca').classList.add("active");
