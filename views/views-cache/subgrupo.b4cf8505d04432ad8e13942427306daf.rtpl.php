              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="" data-toggle="modal" data-target="#modal-lg"
                      onclick='setDadosModal(<?php echo htmlspecialchars( $value1["idsubgrupo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)' class="btn btn-primary btn-block">
            ...
            <div class="card-body">
              <div class="form-group">
                <div class="form-line row">
                  <input class="form-control" type="hidden" name="idsubgrupo" id="idsubgrupo" value=""
                    readonly="readonly" />
                  <div class="col-sm">
                    <label for="nomesubgrupo" id="labelnome">Nome</label>
                    <input type="text" class="form-control" maxlength="100" id="nomesubgrupo" name="nomesubgrupo"
                      placeholder="Digite o nome do subgrupo">
                  </div>
                  <div class="col-sm">
                    <label for="descricaosubgrupo" id="labeldescricao">Descrição</label>
                    <input type="text" class="form-control" maxlength="500" id="descricaosubgrupo"
                      name="descricaosubgrupo" placeholder="Digite a descrição do subgrupo">
                  </div>
                </div>
              </div>
            </div>
