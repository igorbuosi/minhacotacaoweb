            ...
            <table class="table table-head-fixed text-nowrap table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="" data-toggle="modal" data-target="#modal-lg" onclick='setDadosModal(<?php echo htmlspecialchars( $value1["idestado"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)'
            ...
            <div class="card-body">
              <div class="form-group">
                <div class="form-line row">
                  <input class="form-control" type="hidden" name="idEstado" id="idEstado" value=""
                    readonly="readonly" />
                  <div class="col-sm">
                    <label for="siglaEstado" id="labelSigla">Sigla</label>
                    <input type="text" class="form-control" maxlength="2" id="siglaEstado" name="siglaEstado"
                      placeholder="Digite a sigla do estado">
                  </div>
                  <div class="col-sm">
                    <label for="nomeEstado" id="labelNome">Nome</label>
                    <input type="text" class="form-control" maxlength="50" id="nomeEstado" name="nomeEstado"
              ...
              <div class="form-group">
                <div class="form-line row">
                  <div class="col-sm">
                    ...
                    <input type="number" class="form-control" id="codigoEstadoIBGE" maxlength="7"
                      name="codigoEstadoIBGE" placeholder="Digite o código IBGE do estado">
                  </div>
                  <div class="col-sm">
                    <label for="codigoPaisIBGE">Código País IBGE</label>
                    <input type="text" class="form-control" id="codigoPaisIBGE" maxlength="50" name="codigoPaisIBGE"
                      placeholder="Digite o código IBGE do país">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="form-line row">
                  <div class="col-sm">
                    ...
                    <input type="text" class="form-control" id="nomePais" maxlength="100" name="nomePais"
